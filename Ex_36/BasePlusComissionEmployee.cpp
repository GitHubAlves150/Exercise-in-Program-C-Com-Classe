...
BasePlussEmployee::BasePlussEmployee(const string &first, const string &last,
                                     ...
                                     double salary)
                                : comissonEmployee(first, last, ssn, sales, rate)//chama explicitamente o construtor da classe básica
{
...
{
    return _baseSalary + (_comissionRate * _grossSales);//acessando os membros privados ou pprotegidos da classe básica
