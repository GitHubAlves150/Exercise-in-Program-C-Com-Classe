...
//include da bilbioteca básica
#include "Comission.hpp"

class BasePlussEmployee : public ComissionEmployee //indicação de herança- basePlussEmployee herda a ComissionEmployee
{

public:
    //inicialização do construtor
   BasePlussEmployee(const string &, const string &,
                     const string &, double=0.0, double=0, double=0.0): comissonEmployee()//Também deve herdar  o construtor
