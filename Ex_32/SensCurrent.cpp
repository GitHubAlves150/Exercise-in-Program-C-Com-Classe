...
sensCurrent::sensCurrent(const string &sensType, int valorADC, //Quando Herdar uma classe precisa tambem herdar o construtor
                         unsigned sensID, double Vref, double Res): sensvolt(sensType, valorADC, sensID, Vref)
{
    //Nao preciso das demais por estarmos herdando da sensVolt
//    _sensType  = sensType;
//    _valorADC = valorADC;
//    _sensID   = sensID;
//    _Vref     = Vref;
