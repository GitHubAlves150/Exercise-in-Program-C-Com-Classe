...
_CorArmadura(CorArmadura),_NomeAnimal(NomeAnimal), _SexoRanger(SexoRanger), _NomeEscolhido(NomeEscolhido)
{
...
void Zordon::ToShow()
{
    ...
    cout<<"\n          Armadura: "<<getCorArmadura()
        <<"\n            Animal: "<<getNomeAnimal()
        <<"\n              Sexo: "<<getSexoRanger()
        <<"\n Nome do escolhido:"<<getNomeRanger()<<endl;
}
